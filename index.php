                    ...
                    <form method="POST" action="/battle.php">
                        ...
                        <div class="text-center">
                            ...
                            <select name="battle_type" id="battle_type" class="form-control drp-dwn-width center-block">
                                <option value="<?= BattleManager::TYPE_NORMAL ?>">Normal</option>
                                <option value="<?= BattleManager::TYPE_NO_JEDI ?>">No Jedi Powers</option>
                                <option value="<?= BattleManager::TYPE_ONLY_JEDI ?>">Only Jedi Powers</option>
                            </select>
                        </div>
